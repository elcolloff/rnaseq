...
- Document how to use the newer SILVA 138-based SortMeRNA reference databases (`smr_v4.3_*_db.fasta`) via a local manifest, explain why they are not the pipeline default (upstream ships them only as a single 237 MB tarball containing all four variants), and link [#1354](https://github.com/nf-core/rnaseq/issues/1354) / [sortmerna/sortmerna#329](https://github.com/sortmerna/sortmerna/issues/329)
